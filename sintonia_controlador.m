...
options = optimoptions(options, 'PopInitRange',[0 0; 10 10]); % Rango de inicio
options = optimoptions(options, 'CreationFcn',@gacreationuniform); % Poblacion inicial aleatoria
 
% Criterios de parada
options = optimoptions(options, 'Generations', 40);     % Maximo de Generaciones
